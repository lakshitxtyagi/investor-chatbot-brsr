  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h2: ({ children }) => (
          <h2 style={{ margin: "14px 0 9px", fontSize: 16, fontWeight: 600, color: "#e2e8f0" }}>{children}</h2>
        ),
        h3: ({ children }) => (
          <h3 style={{ margin: "10px 0 8px", fontSize: 14, fontWeight: 600, color: "#e2e8f0" }}>{children}</h3>
        ),
        p: ({ children }) => (
        ...
        table: ({ children }) => (
          <div style={{ overflowX: "auto", marginBottom: 12 }}>
            <table style={{ borderCollapse: "collapse", fontSize: 12.5, color: "#cbd5e1", width: "100%" }}>
              {children}
            </table>
          </div>
        ),
        th: ({ children }) => (
          <th style={{ padding: "6px 12px", borderBottom: "1px solid #1e2030", textAlign: "left", color: "#94a3b8", fontWeight: 600, background: "#0f1117" }}>{children}</th>
        ),
        td: ({ children }) => (
          <td style={{ padding: "6px 12px", borderBottom: "1px solid #0f1117", verticalAlign: "top" }}>{children}</td>
        ),
      }}
    >
      {content}
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "32px 40px", display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            {!ddReport && !ddLoading && (
              <div style={{ maxWidth: 600, margin: "auto", width: "100%", textAlign: "center" }}>
                ...
                <p style={{ fontSize: 13, color: "#334155", margin: "0 0 32px", lineHeight: 1.7 }}>
                ...
                <div style={{ background: "#0f1117", border: "1px solid #1e2030", borderRadius: 12, padding: 20, textAlign: "left" }}>
                  <label style={{ fontSize: 11, color: "#475569", textTransform: "uppercase", letterSpacing: "0.08em", display: "block", marginBottom: 8 }}>
                  ...
                  <input
                    ...
                    style={{ width: "100%", background: "#0a0a0f", border: "1px solid #1e2030", borderRadius: 8, padding: "10px 14px", fontSize: 14, color: "#e2e8f0", outline: "none", fontFamily: "inherit", boxSizing: "border-box", marginBottom: 12 }}
                  />
                  ...
                  <input
                    ...
                    style={{ width: "100%", background: "#0a0a0f", border: "1px solid #1e2030", borderRadius: 8, padding: "10px 14px", fontSize: 14, color: "#e2e8f0", outline: "none", fontFamily: "inherit", boxSizing: "border-box", marginBottom: 20 }}
                  />
                ...
                <p style={{ fontSize: 11, color: "#1e2030", marginTop: 16 }}>
            ...
            {ddLoading && (
              <div style={{ maxWidth: 560, margin: "auto", width: "100%", textAlign: "center" }}>
                ...
                <p style={{ fontSize: 13, color: "#64748b", margin: "0 0 6px" }}>Analysing</p>
                <p style={{ fontSize: 15, color: "#94a3b8", fontWeight: 500, margin: 0, letterSpacing: "-0.01em" }}>
            ...
            {ddReport && !ddLoading && (
              <div style={{ maxWidth: 860, margin: "0 auto", width: "100%" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24, flexWrap: "wrap", gap: 12 }}>
                  <div>
                    <div style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.1em", color: "#475569", marginBottom: 4 }}>Due Diligence Report</div>
                    <h2 style={{ margin: 0, fontSize: 22, fontWeight: 600, color: "#e2e8f0", letterSpacing: "-0.02em" }}>
                      {ddReport.company}
                      {ddReport.symbol && <span style={{ fontSize: 14, color: "#6366f1", marginLeft: 10, fontWeight: 400 }}>{ddReport.symbol}</span>}
                    </h2>
                  </div>
                  <div style={{ display: "flex", gap: 10 }}>
                    {ddReport.total_sources > 0 && (
                      <button
                        ...
                        style={{ fontSize: 12, color: "#6366f1", background: "none", border: "1px solid #312e81", borderRadius: 6, padding: "6px 14px", cursor: "pointer", fontFamily: "inherit" }}
                      >
                ...
                <div style={{ background: "#0f1117", border: "1px solid #1e2030", borderRadius: 12, padding: "28px 32px", fontSize: 13.5, lineHeight: 1.75 }}>
          ...
          <>
            <div style={{ padding: "16px 20px", borderBottom: "1px solid #1e2030", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
              <div>
                ...
                <div style={{ fontSize: 11, color: "#475569" }}>{activeSources.label}</div>
              </div>
